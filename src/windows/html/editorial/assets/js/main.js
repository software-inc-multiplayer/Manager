...
(function ($) {
    ...
    $window.on("load", function () {
        ...
        $("#prcheck").click(() => {
            ...
            if (document.getElementById("prcheck").checked) {
                $checkboxesChecked.push("prcheck");
                checkArr();
                return;
            } else {
                $checkboxesChecked.splice(
                    $checkboxesChecked.indexOf("prcheck"),
                    1
                );
                checkArr();
                return;
        ...
        $("#unscheck").click(() => {
            console.log();
            if (document.getElementById("unscheck").checked) {
                $checkboxesChecked.push("unscheck");
                checkArr();
                return;
            } else {
                $checkboxesChecked.splice(
                    $checkboxesChecked.indexOf("unscheck"),
                    1
                );
                checkArr();
                return;
        ...
        $("#hischeck").click(() => {
            if (document.getElementById("hischeck").checked) {
                $checkboxesChecked.push("hischeck");
                checkArr();
                return;
            } else {
                $checkboxesChecked.splice(
                    $checkboxesChecked.indexOf("hischeck"),
                    1
                );
                checkArr();
                return;
